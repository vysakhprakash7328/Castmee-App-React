      ...
      {isDropdownOpen && (
        <div style={styles.Dropdown}>
          <div
            ...
            onClick={() => alert('Settings clicked')} // Handle settings click
          >
            Settings
          </div>
          <div
            style={styles.DropdownItem}
            onClick={() => alert('Logout clicked')} // Handle logout click
          >
            Logout
          </div>
        </div>
...
export default CastingProducerHeader;
