...
export default function SignupFormProducer({ formData, handleFormChange, handlePrevPageArtist,handleSubmit }) {
    ...
    return (
        <>
            ...
            <div className="input-field">
                <i className="fas fa-lock"></i>
                <input type="password" name="confirm_password" value={formData.confirm_password} onChange={handleFormChange} placeholder="Repeat Password" />
            </div>
